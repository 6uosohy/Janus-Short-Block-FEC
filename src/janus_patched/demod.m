...
function [data, dec_bits, dlv_seq, bit_prob] = demod(pset, bband, bband_fs, slots, nbits, cfactor, params)
    ...
    nchip = fec_coded_length(nbits, params);
    ...
    [dec_bits, dlv_seq] = fec_decode_soft_bits(bit_prob, nbits, params);
